...
- [ ] PP4: WordArt prstTxWarp — **PR #838 open**(a:prstTxWarp, §20.1.9.19)。マージ待ち。関連 follow-up issue #846(単一辺 warp textArchUp/Down/Circle は full-path stretch でなく natural width で path 追従すべき)。
...
- [ ] XL4: アウトライングルーピング — **PR #843 open**(row/column outline grouping: gutter + collapse/expand)。マージ待ち。
...
- [ ] IX6: worker モードのテキスト選択パリティ(docx / pptx) — **PR #841 open**(text selection & findText parity in worker mode)。マージ待ち。
